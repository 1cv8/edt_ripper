...
Процедура Прочитать(Файл, ПутьКРепозиторию, СписокПроектов, ФайлРезультата, ПутиКакВЛинукс) Экспорт
	...
	ЕстьФитрПравилПоID = ПараметрыПроверки.ЕстьФитрПравилПоID();
	ЕстьФитрПравилПоКоду = ПараметрыПроверки.ЕстьФитрПравилПоКоду();
	...
	Пока ПрочитаннаяСтрока <> Неопределено Цикл
		...
		Если ЕстьФитрПравилПоКоду Тогда
